...
<!--GREEN STRIPE-->
<tr>
	<td width="31" bgcolor="#C32A2D" style="border-top:1px solid #FFF; border-bottom:1px solid #FFF;" height="113">
	<div style="line-height: 0px; font-size: 1px; position: absolute;">&nbsp;</div>
	</td>
	
	<!--WHITE TEXT AREA-->
	<td width="131" bgcolor="#FFFFFF" style="border-top:1px solid #FFF; text-align:center;" height="113" valign="middle">
	<span style="font-size:25px; font-family:Trebuchet MS, Verdana, Arial; color:#C32A2D;">FLAROW</span>
	</td>
	
	<!--GREEN TEXT AREA-->
	<td bgcolor="#C32A2D" style="border-top:1px solid #FFF; border-bottom:1px solid #FFF; padding-left:15px;" height="113">
	<span style="color:#FFFFFF; font-size:18px; font-family:Trebuchet MS, Verdana, Arial;">Welcome to Flarow!</span>
	</td>
</tr>
...
<tr>
	...
	<span style="font-family:Trebuchet MS, Verdana, Arial; font-size:17px; font-weight:bold;">Welcome {{$name}}!</span>
	<br />
	<p>Thank your for Registering with Flarow!</p>
	<br />
	<div style="padding-left:20px; padding-bottom:10px;"><img src="images/spade.gif" alt=""/>&nbsp;&nbsp;&nbsp;Explore our property listing</div>

	<div style="padding-left:20px; padding-bottom:10px;"><img src="images/spade.gif" alt=""/>&nbsp;&nbsp;&nbsp;Pay/Receive rent online</div>
	<div style="padding-left:20px; padding-bottom:10px;"><img src="images/spade.gif" alt=""/>&nbsp;&nbsp;&nbsp;Rent/Book property with ease</div>

	<p>In the meantime, you can <a href="http://flarow.com">return to my website</a> to continue browsing.</p>

   Best Regards,<br/>
   Flarow<br/>
   <br/>

   This welcome email was sent to $email because you recently signed up at <a href="http://flarow.com/#/register">flarow.com</a>
	...
	<p>To help ensure that you receive all email messages consistently in your inbox with images displayed, please add this address to your address book or contacts list: <strong>support@flarow.com</strong>.</p>
	<br />
	</td>
	</tr>
	</table>
