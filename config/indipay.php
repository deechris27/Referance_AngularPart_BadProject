...
return [
    ...
    */
    ...
    'payumoney' => [                         // PayUMoney Parameters
        'merchantKey'  => env('INDIPAY_MERCHANT_KEY', 'uxlAaZMp'),
        'salt'  => env('INDIPAY_SALT', 'LQ3Z9iP6c0'),
        'workingKey' => env('INDIPAY_WORKING_KEY', 'uxlAaZMp'),

        // Should be route address for url() function
        'successUrl' => env('INDIPAY_SUCCESS_URL', 'transresponse'),
        'failureUrl' => env('INDIPAY_FAILURE_URL', 'transresponse'),
    ],
